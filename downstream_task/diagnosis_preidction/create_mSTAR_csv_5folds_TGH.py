...
# Load the TSV file
df = pd.read_csv("/home/jma/Documents/Beatrice/configs/TGH_k=5.tsv", sep="\t")
...
# Save to CSV
df.to_csv("/home/jma/Documents/Beatrice/mSTAR/downstream_task/diagnosis_preidction/dataset_csv/TGH_5folds.csv", index=False)
